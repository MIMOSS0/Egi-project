window.onload = function() {
    const fileList = JSON.parse(localStorage.getItem('fileList2')) || [];
    const fileListDiv = document.getElementById('fileList2');
...
function deleteFile(index) {
    let fileList = JSON.parse(localStorage.getItem('fileList2')) || [];
    fileList.splice(index, 1);
    localStorage.setItem('fileList2', JSON.stringify(fileList));
